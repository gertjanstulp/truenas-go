...
func TestSSHClient_ConnectMethod_Success(t *testing.T) {
	...
	if version.Flavor != truenas.FlavorScale {
...
func TestSSHClient_CallAndWait_V25_UsesJobFlag(t *testing.T) {
	...
	client.version = truenas.Version{Major: 25, Minor: 4, Raw: "TrueNAS-25.04"}
...
func TestSSHClient_CallAndWait_V24_UsesPolling(t *testing.T) {
	...
	client.version = truenas.Version{Major: 24, Minor: 10, Raw: "TrueNAS-24.10"}
	client.connected = true
...
func TestSSHClient_CallAndWait_RespectsSemaphore(t *testing.T) {
	...
	client := &SSHClient{
		...
		version:       truenas.Version{Major: 25, Minor: 4, Raw: "TrueNAS-25.04"},
		logger:        NopLogger{},
	}
